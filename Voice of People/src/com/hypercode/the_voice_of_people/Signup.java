...
public class Signup extends Activity{
	...
	public void signup(View v) {
		...
		if (all_fields_are_ok ) {
        	...
        	task.execute("http://10.0.2.2:8081/3w/signup");
        }
        else {
	...
	private class HttpAsyncTask extends AsyncTask<String, Void, String> {
        ...
        protected void onPostExecute(String result) {
        	...
        	if (result.equals("SUCCESSFULLY_REGISTERED")){
        		Toast.makeText(getBaseContext(), "Success signup!", Toast.LENGTH_LONG).show();
        		
        		Intent profile_settings=new Intent("com.hypercode.the_voice_of_people.PROFILE_SETTINGS");
